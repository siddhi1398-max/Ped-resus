...
import PrehospitalManagement from "./components/tabs/ImagingTab";
import ManagementAlgorithms from "./components/tabs/IAPGuidelinesTab";
import {
  Calculator, Wrench, Wind, Pill, Heartbeat, TreeStructure, Drop, Eyedropper, Baby,
  ClipboardText, Syringe, Stethoscope, FirstAid, Hospital,
  Lock, X, BookOpen,
...
const ALL_TABS = [
  ...
  { id: "iap",           label: "Management Algorithms",icon: BookOpen,      Comp: IAPGuidelinesTab,     free: false },
  { id: "prehospital",   label: "Prehospital Management",icon: Hospital,     Comp: ImagingTab,           free: false },
];
