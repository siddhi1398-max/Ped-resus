  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-3 sm:px-6">
        ...
        {/* ── Logo + buttons row — always visible ── */}
        ...
        <div className="flex items-center gap-2 pb-2">
          ...
          {/* WEIGHT label — hidden on mobile to save space */}
          ...
          {/* Slider — gets all remaining space */}
          <Slider
          ...
          <div className="flex items-center gap-1 flex-shrink-0">
            <Input
              ...
              className="w-14 h-8 font-mono text-right text-sm font-bold px-1.5"
            />
          ...
          {/* Broselow zone — always visible, tighter on mobile */}
          <div
