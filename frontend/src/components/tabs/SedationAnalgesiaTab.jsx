...
const PSA_AGENTS = [
  {
    name: "Ketamine", class: "Dissociative", classColor: "violet",
    ivDose: "1–2 mg/kg IV", imDose: "4–5 mg/kg IM", inDose: "—",
    onset: "1 min IV / 5 min IM", duration: "10–20 min IV / 30–60 min IM",
    analgesia: true, amnesia: true,
    airway: "Maintained", airwayColor: "emerald", bp: "↑ / Stable", bpColor: "emerald",
    reversal: "None",
  ...
  {
    name: "Propofol", class: "Hypnotic", classColor: "blue",
    ivDose: "1–2 mg/kg IV then 0.5 mg/kg PRN", imDose: "—", inDose: "—",
    onset: "30 s", duration: "5–10 min",
    analgesia: false, amnesia: true,
    airway: "Risk of apnoea", airwayColor: "red", bp: "↓ Hypotension", bpColor: "red",
    reversal: "None",
  ...
  {
    name: "Midazolam", class: "Benzodiazepine", classColor: "sky",
    ivDose: "0.05–0.1 mg/kg IV (max 5 mg)", imDose: "0.1–0.2 mg/kg IM", inDose: "0.2 mg/kg IN (max 10 mg)",
    onset: "2 min IV / 5 min IN", duration: "30–60 min",
    analgesia: false, amnesia: true,
    airway: "Respiratory depression", airwayColor: "amber", bp: "Mild ↓", bpColor: "amber",
  ...
  {
    name: "Fentanyl", class: "Opioid", classColor: "orange",
    ivDose: "1–2 mcg/kg IV slow", imDose: "—", inDose: "1.5 mcg/kg IN",
    onset: "1 min IV / 5–10 min IN", duration: "30–60 min",
    analgesia: true, amnesia: false,
    airway: "Respiratory depression", airwayColor: "amber", bp: "Stable", bpColor: "emerald",
  ...
  {
    name: "Ketofol (1:1 mix)", class: "Combination", classColor: "emerald",
    ivDose: "0.5–1 mg/kg of mixture IV titrated", imDose: "—", inDose: "—",
    onset: "30–60 s", duration: "5–10 min",
    analgesia: true, amnesia: true,
    airway: "Generally maintained", airwayColor: "emerald", bp: "Stable (synergy balances effects)", bpColor: "emerald",
    reversal: "None",
  ...
  {
    name: "Dexmedetomidine", class: "α2-agonist", classColor: "teal",
    ivDose: "Load 0.5–1 mcg/kg over 10 min, then 0.2–0.7 mcg/kg/hr", imDose: "—", inDose: "1–2 mcg/kg IN (procedural)",
    onset: "5–10 min IV", duration: "60–90 min",
    analgesia: false, amnesia: false,
    airway: "Preserved — no respiratory depression", airwayColor: "emerald", bp: "Bradycardia / hypotension", bpColor: "amber",
    reversal: "None",
  ...
  {
    name: "Nitrous oxide (50:50)", class: "Inhaled", classColor: "slate",
    ivDose: "—", imDose: "—", inDose: "Self-administered inhalation",
    onset: "30–60 s", duration: "5 min (rapid offset)",
    analgesia: true, amnesia: true,
    airway: "Self-maintained", airwayColor: "emerald", bp: "Stable", bpColor: "emerald",
  ...
  {
    name: "Etomidate", class: "Hypnotic (RSI)", classColor: "red",
    ivDose: "0.3 mg/kg IV", imDose: "—", inDose: "—",
    onset: "30 s", duration: "5–10 min",
    analgesia: false, amnesia: true,
    airway: "Apnoea (RSI context)", airwayColor: "red", bp: "Neutral — haemodynamically stable", bpColor: "emerald",
    reversal: "None",
...
const ORAL_SEDATIVES = [
  {
    drug: "Midazolam", class: "Benzodiazepine", classColor: "sky",
    brands: "Versed (Roche) · Mezolam (Neon) · Dormalin (Torrent) · Dormicum (Roche)",
    dose: "0.3–0.6 mg/kg PO (max 15 mg)", onset: "15–20 min", working: "30–45 min", halfLife: "1.7–2.4 hr",
    reversal: "Flumazenil 0.01 mg/kg IV", airway: "Resp. depression", airwayColor: "amber",
  ...
  {
    drug: "Triclofos Sodium", class: "Sedative-Hypnotic", classColor: "violet",
    brands: "Pedicloryl (FDC) · Tricloryl · Calmax (Alkem) · Hypnoderm",
    dose: "50–75 mg/kg PO (max 1,000 mg)", onset: "20–40 min", working: "6–8 hr", halfLife: "4–8 hr (trichloroethanol)",
    reversal: "None", airway: "Mild depression", airwayColor: "amber",
    formulations: "Syrup 500 mg/5 mL — widely available in India · Oral solution",
    comments: "Preferred oral sedative for non-painful procedural sedation in Indian children (EEG, echo, MRI, ophthalmology). Metabolised to trichloroethanol (same active metabolite as chloral hydrate). Palatable syrup — well accepted. NOT analgesic.",
  ...
  {
    drug: "Chloral Hydrate", class: "Sedative-Hypnotic", classColor: "rose",
    brands: "Discontinued in India · Previously: Somnote, Noctec",
    dose: "25–100 mg/kg PO (max 1,000 mg)", onset: "30–60 min", working: "60–90 min", halfLife: "4–8 hr (trichloroethanol)",
    reversal: "None", airway: "Resp. depression", airwayColor: "red",
  ...
  {
    drug: "Hydroxyzine", class: "Antihistamine", classColor: "amber",
    brands: "Atarax (UCB) · Vistaril · Hydroxyzine (Cipla, Sun)",
    dose: "1–2 mg/kg PO (max 50 mg)", onset: "30–45 min", working: "30–45 min", halfLife: "3–7 hr",
    reversal: "None", airway: "Preserved", airwayColor: "emerald",
  ...
  {
    drug: "Diphenhydramine", class: "Antihistamine", classColor: "amber",
    brands: "Benadryl (Pfizer/J&J) · Zydryl · Dimedrol · Diphen (various)",
    dose: "1–2 mg/kg PO (max 50 mg)", onset: "5–30 min", working: "30–45 min", halfLife: "4–7 hr",
    reversal: "None", airway: "Preserved", airwayColor: "emerald",
  ...
  {
    drug: "Promethazine", class: "Phenothiazine", classColor: "orange",
    brands: "Phenergan (Sanofi) · Fenez (FDC) · Promethafix · Avomine",
    dose: "0.5–1 mg/kg PO (max 25 mg)", onset: "15–30 min", working: "60 min", halfLife: "10–19 hr",
    reversal: "None", airway: "Resp. depression", airwayColor: "red",
  ...
  {
    drug: "Diazepam", class: "Benzodiazepine", classColor: "sky",
    brands: "Valium (Roche) · Calmpose (Ranbaxy) · Paxum (Torrent) · Antenex",
    dose: "0.25–0.5 mg/kg PO (max 10 mg)", onset: "20–30 min", working: "60 min", halfLife: "20–100 hr (+ active metabolites)",
    reversal: "Flumazenil 0.01 mg/kg IV", airway: "Resp. depression", airwayColor: "amber",
  ...
  {
    drug: "Lorazepam", class: "Benzodiazepine", classColor: "sky",
    brands: "Ativan (Wyeth/Pfizer) · Calmdown (Cipla) · Lor (Sun Pharma) · Larpose",
    dose: "0.05 mg/kg PO/SL (max 2 mg)", onset: "30–60 min", working: "60–90 min", halfLife: "10–20 hr",
    reversal: "Flumazenil 0.01 mg/kg IV", airway: "Resp. depression", airwayColor: "amber",
  ...
  {
    drug: "Ketamine (oral)", class: "NMDA Antagonist", classColor: "violet",
    brands: "Ketamine (Neon, Troikaa) · Ketalar · Aneket",
    dose: "3–6 mg/kg PO (+ midazolam 0.3 mg/kg PO)", onset: "20–40 min", working: "20–120 min (wide variability)", halfLife: "2–3 hr (oral bioavailability 16–20%)",
    reversal: "None", airway: "Generally maintained", airwayColor: "emerald",
  ...
  {
    drug: "Dexmedetomidine (IN)", class: "α2-agonist", classColor: "teal",
    brands: "Precedex (Hospira/Pfizer) · Dextomid (Neon) · Dexdor",
    dose: "1–2 mcg/kg IN (procedural)", onset: "30 min IN", working: "60–120 min", halfLife: "2–3 hr",
    reversal: "None (atipamezole not routinely available)", airway: "Preserved — no resp. depression", airwayColor: "emerald",
...
// PSA agents  → 3 panels in one row: Best For · Cautions · Pearl
// Oral sedatives → 4 panels in one row: [Brands + Formulations] · Comments · Cautions · Pearl
//
// KEY FIX: Indian Brands and Formulations are merged into a single panel
// (two sub-rows separated by a divider), so the oral row always renders
// exactly 4 panels fitting in one lg:grid-cols-4 row.
function ExpandedDetail({ bestFor, cautions, pearl, brands, formulations, comments, colSpan }) {
  ...
  return (
    <tr>
      <td
        colSpan={colSpan}
        className="px-4 pb-4 pt-2 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800"
      >

        {/* ── PSA agents: 3 equal columns ── */}
        {!isOral && (
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="bg-white dark:bg-slate-900 rounded-lg p-3 border border-slate-200 dark:border-slate-700">
              ...
              <p className="text-xs text-slate-700 dark:text-slate-200 leading-relaxed">{bestFor}</p>
            </div>
            <div className="bg-red-50 dark:bg-red-950/30 rounded-lg p-3 border border-red-200 dark:border-red-800">
              ...
              <p className="text-xs text-slate-700 dark:text-slate-200 leading-relaxed">{cautions}</p>
            </div>
            <div className="bg-amber-50 dark:bg-amber-950/30 rounded-lg p-3 border border-amber-200 dark:border-amber-800">
              ...
              <p className="text-xs text-amber-800 dark:text-amber-200 leading-relaxed">{pearl}</p>
            </div>
          </div>
        )}

        {/* ── Oral sedatives: 4 equal columns in one row ── */}
        {isOral && (
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">

            {/* Panel 1 — Brands + Formulations merged with internal divider */}
            <div className="bg-white dark:bg-slate-900 rounded-lg p-3 border border-slate-200 dark:border-slate-700 flex flex-col">
              {/* Brands sub-section */}
              ...
              <p className="text-xs text-slate-700 dark:text-slate-200 leading-relaxed mb-2.5">{brands}</p>
              {/* Divider */}
              <div className="border-t border-slate-100 dark:border-slate-700 my-0" />
              {/* Formulations sub-section */}
              ...
              <p className="text-xs text-slate-700 dark:text-slate-200 leading-relaxed">{formulations}</p>
            </div>

            {/* Panel 2 — Clinical Comments */}
            <div className="bg-white dark:bg-slate-900 rounded-lg p-3 border border-slate-200 dark:border-slate-700">
              <div className="flex items-center gap-1.5 mb-1.5">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">{comments}</p>
            </div>
...
function PSAAgentTable({ weight, searchEntry }) {
  ...
  return (
    <div className="space-y-3">
      <p className="text-xs text-slate-500 dark:text-slate-400 font-mono">
        Doses calculated for <span className="text-slate-900 dark:text-white font-bold">{weight} kg</span>. Tap any row to expand.
      </p>
  ...
  onClick={() => setExpanded(isOpen ? null : a.name)}
                  ...
                  {isOpen && (
                    <ExpandedDetail
                      key={`${a.name}-exp`}
                      bestFor={a.bestFor} cautions={a.cautions} pearl={a.pearl}
                      colSpan={COLS.length}
                    />
                  )}
                </>
...
function OralSedationTable({ weight, searchEntry }) {
  ...
  const calcDose = (doseStr, wt) => {
    ...
    if (mgKg) {
      ...
      if (hiC) return `${loC}–${hiC} mg${cap && hi >= cap ? ` (max ${cap})` : ""}`;
      return `${loC} mg${cap && lo >= cap ? ` (max ${cap})` : ""}`;
    }
    if (mcgKg) {
  ...
  return (
    <div className="space-y-3">
      <p className="text-xs text-slate-500 dark:text-slate-400 font-mono">
        Weight-based doses for <span className="text-slate-900 dark:text-white font-bold">{weight} kg</span>.
  ...
  onClick={() => setExpanded(isOpen ? null : os.drug)}
                    ...
                    <td className="px-3 py-2.5">
                      ...
                      <span className={`inline-block text-[8px] font-mono uppercase tracking-wider px-1.5 py-0.5 rounded border mt-0.5 ${CMAP[os.classColor]}`}>{os.class}</span>
                    </td>
                    <td className="px-3 py-2.5 font-mono text-slate-600 dark:text-slate-300 text-[10px]">{os.dose}</td>
                    <td className="px-3 py-2.5">
                      <div className="font-mono font-bold text-blue-600 dark:text-blue-400">{calcDose(os.dose, weight)}</div>
                    </td>
                    <td className="px-3 py-2.5 font-mono text-slate-700 dark:text-slate-200">{os.onset}</td>
                    ...
                    <td className="px-3 py-2.5">
                      <span className={`text-[9px] font-mono px-1.5 py-0.5 rounded border ${CMAP[os.airwayColor]}`}>{os.airway}</span>
                    </td>
                    <td className="px-3 py-2.5 text-slate-500 dark:text-slate-400 text-[10px]">{os.reversal}</td>
                  </tr>
                  {isOpen && (
                    <ExpandedDetail
                      key={`${os.drug}-exp`}
                      brands={os.brands} formulations={os.formulations}
                      comments={os.comments} cautions={os.cautions} pearl={os.pearl}
                      colSpan={COLS.length}
                    />
                  )}
                </>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-start gap-2 rounded-lg border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/30 px-3 py-2.5 text-xs text-amber-800 dark:text-amber-200">
        ...
        <span>All sedation must be performed with appropriate monitoring, trained personnel, and emergency equipment immediately available. Reference only — individualise to patient.</span>
      </div>
  ...
  <OralSedationTable weight={weight} searchEntry={searchEntry} />
        ...
        <div className="space-y-2">
          {(psaSection === "pre"
            ...
            <div key={i} className="flex items-start gap-2.5 text-xs text-slate-600 dark:text-slate-300">
              <span className="w-5 h-5 rounded-full bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-200 text-[9px] flex items-center justify-center font-bold flex-shrink-0 mt-0.5">{i + 1}</span>
              {item}
            </div>
          ))}
        </div>
      ...
      <Section title="Pediatric ED Nerve Blocks" sectionKey="blocks">
        <div className="space-y-3">
          ...
          {NERVE_BLOCKS.map(block => <NerveBlockCard key={block.id} block={block} />)}
        </div>
      </Section>
